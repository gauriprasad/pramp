...
class BSTSuccessorSearch {
  ...
  static class BinarySearchTree {
    ...
    Node findInOrderSuccessor(Node inputNode) {
      // if you have a right child, go to right child and as left as you can
      // travel upwards until you are a part of the left subtree of the parents, that parent is the ans
      ...
      temp = temp.parent; // parent pointer
      Node child = inputNode;
      
      while(temp != null && temp.left != child){
        child = temp;
        temp = temp.parent;
      }
      return temp;
